        ...
        <Container>
          <Row>
            <Col style={{
              ...
              <Container>
                <Row>
                  <Button style={{ backgroundColor: "#23272b", color: "white" }} variant="contained" block href={"https://maps.google.com/?q=" + latDisp + "," + lngDisp} target="_blank" rel="noopener" disableElevation>
