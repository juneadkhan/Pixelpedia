        ...
        <div className={darkTheme ? 'dark-theme' : '#202020'}>
          <Navbar>
            ...
            <Tooltip title={'View Instagram'} arrow>
              <IconButton aria-label="insta" href="https://www.instagram.com/pixelpedia.io/" target="_blank" rel="noopener">
                {darkTheme
          ...
          <Modal.Body style={{ backgroundColor: darkTheme ? '#202020' : 'white', color: darkTheme ? 'white' : 'black' }}>
            ...
            <Container style={{ display: "flex", justifyContent: 'center' }}>
              ...
              <Button style={{ marginLeft: "0.4rem" }}
                ...
                disableElevation
                href="https://docs.google.com/forms/d/e/1FAIpQLSf4OcdHdulTPqXFh_A56PoO4Je_VxkNKMEIi34wrljER0EorQ/viewform" target="_blank" rel="noopener" >
                Submit a Photo Spot</Button>
            </Container>
          </Modal.Body>
        </Modal>
